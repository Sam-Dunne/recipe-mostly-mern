    ...
    return (
        <Navbar collapseOnSelect expand="lg" bg="primary" variant="dark">
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
                ...
                <Nav.Link href={`/addrecipe`} className='ml-3 text-light'>Add Recipe</Nav.Link>
                <Nav.Link href={`/login`} className='ml-3 text-light'>Login</Nav.Link>
                <Nav.Link href={`/register`} className='ml-3 text-light'>Register</Nav.Link>
                <Nav.Link href={`/login`} className='ml-3 text-light' onClick={handleLogout}>Logout</Nav.Link>
