        ...
        <section className='justify-content-center col-md-8 rounded shadow-lg bg-primary p-2 px-md-4 mx-2'>
            ...
            <Form className='p-4 mb-3'>
                ...
                <div className='row justify-content-center mt-3 mb-1'>
                    <Link to='/register' className='btn btn-link border-light text-light'>Already Signed Up...Login</Link>
                </div>
            </Form>
        </section>
    );
