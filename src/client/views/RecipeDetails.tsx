                ...
                <div className="row d-flex justify-content-around align-items-center">
                    <div className="card card-body rounded shadow bg-light pb-3 col-12 col-md-8 col-lg-10">
                        ...
                        {recipeFlavorTags?.map(tag => (
                            <div key={tag.id}>
                                <span className="badge badge-success">{tag.name}</span>
                            </div>
                        ))}
