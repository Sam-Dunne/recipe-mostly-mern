    ...
    return (
        <>
            <section className="container my-2">
                ...
                <div className="row bg-primary justify-content-between align-items-center mx-auto rounded shadow col-12 col-md-10 col-lg-8">
                ...
                <div className="row d-flex justify-content-center align-items-center rounded p-3">
                    <div className="card bg-primary p-2 px-md-3 py-md-4 col-12 col-md-10 col-lg-8">
